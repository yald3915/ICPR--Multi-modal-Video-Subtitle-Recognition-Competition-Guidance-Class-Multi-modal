This file is the baseline code for Multi-modal Video Subtitle Recognition Competition Guidance Class 

以上文件是Multi-modal Video Subtitle Recognition Competition Guidance Class （视频字幕指导大赛）比赛的baseline代码
